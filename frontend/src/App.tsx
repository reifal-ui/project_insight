...
import PublicSurveyPage from "./components/form/form-elements/PublicSurveyPage"; // IMPORT INI
    ...
    <>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/TailAdmin/survey/:shareToken" element={<PublicSurveyPage />} /> {/* TAMBAH INI */}
