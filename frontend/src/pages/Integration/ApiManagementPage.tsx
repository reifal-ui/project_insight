...
export default function ApiManagementPage() {
  ...
  const handleCreateKey = async () => {
    ...
    setIsCreating(true);
    showToast("Creating API key...", 'loading');
  ...
  const handleDeleteKey = async (keyId: string) => {
    ...
    showToast("Deleting API key...", 'loading');
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800 p-6">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-start gap-2">
                ...
                <code className="text-gray-800 dark:text-gray-200">/api/v1/surveys/&#123;id&#125;/</code>
                <span className="text-gray-600 dark:text-gray-400">- Get survey details</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded font-mono text-xs">
                  GET
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-4">
              Include your API key in the Authorization header: <code className="bg-gray-200 dark:bg-gray-700 px-1 py-0.5 rounded">Authorization: ApiKey YOUR_API_KEY</code>
            </p>
          </div>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 text-xs mb-2">
                        {key.can_read && <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded">Read</span>}
                        {key.can_write && <span className="px-2 py-0.5 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded">Write</span>}
                        {key.can_delete && <span className="px-2 py-0.5 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 rounded">Delete</span>}
                      </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 dark:bg-gray-700 dark:text-gray-300"
                  >
                    Cancel
                  </button>
                  <button
